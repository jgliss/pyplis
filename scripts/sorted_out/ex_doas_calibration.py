...
ax.figure.savefig(join(save_path, "ex9_1_so2_cds_scatter.png"))
...
i, f = doas_res_std.start_acq - timedelta(1./12),\
                    doas_res_std.stop_acq - timedelta(1./12)
...
fig.savefig(join(save_path, "ex9_2_first_aa_image.png"))

on_list.pyrlevel = pyrlevel_stack
...
fig.savefig(join(save_path, "ex9_3_corrimgs.png"))
...
ax.legend()
fig.savefig(join(save_path, "ex9_4_calib_poly.png"))
