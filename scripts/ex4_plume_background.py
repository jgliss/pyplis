...
plume_file = join(img_dir,\
                'EC2_1106307_1R02_2015091607065477_F01_Etnaxxxxxxxxxxxx.fts')
bg_file = join(img_dir,\
                'EC2_1106307_1R02_2015091607022602_F01_Etnaxxxxxxxxxxxx.fts')
offset_file = join(img_dir,\
                'EC2_1106307_1R02_2015091607064723_D0L_Etnaxxxxxxxxxxxx.fts')
dark_file = join(img_dir, 
                'EC2_1106307_1R02_2015091607064865_D1L_Etnaxxxxxxxxxxxx.fts')

use_auto_settings = False # If this is True, then sky reference areas are set in auto mode
test_case = 0 # DELETE THIS BEFORE PUBLISHING
...
if test_case:
    ...
    #==============================================================================
plt.show()
fig.savefig(join(save_path, "ex4_bg_corr_ref_sects.png"))
fig4.savefig(join(save_path, "ex4_bg_corr_ICAs.png"))
fig0.savefig(join(save_path, "ex4_bg_corr_0.png"))
fig1.savefig(join(save_path, "ex4_bg_corr_1.png"))
fig2.savefig(join(save_path, "ex4_bg_corr_2.png"))
fig3.savefig(join(save_path, "ex4_bg_corr_3.png"))
