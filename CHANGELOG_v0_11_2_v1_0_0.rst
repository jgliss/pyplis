...
#. Changed color and plot styles in some of the standard plotting methods (e.g. cross-correlation velocity)
...
#. Imrovements in efficiency and new methods in :class:`MeasGeometry` objects.
